...
This is a modified version of the `getF1Schedule()` function from the `formula1data` package. Used to create the calendar tab in the shiny app.
...
ui <- navbarPage(title = "Formula 1 Dashboard",
                  ...
                  tabPanel(title = "Race Results 2021",
                           ...
                           selectInput(inputId = "race_gif", label = "Select a round to animate from the 2021 season", choices = c("Bahrain" = 1, "Imola" = 2),
                                       selected = NULL),
                           imageOutput("results_gif", width = "600px", height = "400px"),
                           br(),br(),br(),br(),br(),br(),
...
server <- function(input, output) {
  ...
  lapinfo <- reactive({
    getLapsByRace(2021, input$race_gif)
  })
